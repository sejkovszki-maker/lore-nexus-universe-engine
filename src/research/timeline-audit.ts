...
export const timelineAuditReport={eventCount:verifiedTimeline.length,primaryAudited,sourceRequired:verifiedTimeline.length-primaryAudited,conflicts:[] as string[],unplacedEvents:['All Who Lie — Belial visszatérése hivatalos, de a fő kronológia pontos pontja szerkesztői ellenőrzésre vár.','A Light Extinguished — Neyrelle halála hivatalos Lord of Hatred-spoiler; csak a kampány belső sorrendjének további ellenőrzése után illeszthető a fő idővonalba.','Dawn of Hatred — a Vessel of Hatred utáni relatív helyzet igazolt, de az Akarat személyazonosságára vonatkozó történeten belüli bizonytalanság miatt nem képez automatikus történelmi eseményt.','Demonsbane / Blackmarch — a történeti kapcsolat két bibliográfiai összefoglalóval igazolt, de játékbeli vagy Blizzard-primary időpont nélkül nem kap abszolút dátumot.'],gaps:['A forrásaudit eseményszintű folytatása szükséges; a stabil relatív sorrend közben változatlan.'],releaseStatus:'CONDITIONAL_PASS' as const};
